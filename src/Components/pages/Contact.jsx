    ...
    <div>
      <div>
        <img
          ...
          src="https://res.cloudinary.com/dpf3ipd7p/image/upload/v1755015373/business-website-page-contact-businessman-touching-us-icons-customer-service-include-telephone-address-email-message-d-227408342_tamxbu.webp"
          alt="about us image"
        />
      </div>
      <div>
        ...
        <div className=' flex justify-center'>
          <a
            target='blanket'
            className=" border border-orange-500 py-1 px-5 "
            href="https://www.upwork.com/freelancers/~01f79fa3d73d7c8d81"
          >
            Contact Me in Upwork
          </a>
        </div>
      </div>
    </div>
